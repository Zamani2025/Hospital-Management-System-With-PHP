<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title" style="font-weight: bold;">Edit Doctor</h3>
        </div>
        <div class="row">    
            <div class="col-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data" wire:submit.prevent="updateDoctor">
                        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" wire:model="newImage" class="form-control" id="image" class=" @error("image") border-danger @enderror">
                        @error("image")
                            <span class="text-danger">{{$message}}</span><br>
                        @enderror
                        
                        @if ($newImage)
                            <img src="{{$newImage->temporaryUrl()}}" alt="" width="120" height="120" class="mt-3 rounded-lg">
                        @else
                        <img src="{{asset ('storage/doctors')}}/{{$image}}" width="120" height="120" class="mt-3 rounded-lg" alt="">
                        @endif
                    </div>
                    <button type="submit" class="btn btn-primary mr-2">Edit Doctor</button>
                    </form>
                </div>
                </div>
            </div>
